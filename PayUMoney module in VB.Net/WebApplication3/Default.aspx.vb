...
Public Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            productinfo.Text = "{""paymentParts"":" + GetJson().ToString() + "}"
    ...
    Public Function GetJson() As String
        ...
        dtEmployee.Columns.Add("name", GetType(String))
        dtEmployee.Columns.Add("description", GetType(String))
        dtEmployee.Columns.Add("value", GetType(String))
        dtEmployee.Columns.Add("merchantId", GetType(String))
		 dtEmployee.Columns.Add("commission", GetType(String))
        ...
        For Each dr As DataRow In dtEmployee.Rows
            ...
            For Each col As DataColumn In dtEmployee.Columns
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles submit.Click
        Try
            ...
            If Not String.IsNullOrEmpty(hash1) Then
                ...
                data.Add("productinfo", HttpUtility.HtmlEncode("{""paymentParts"":" + GetJson().ToString() + "}"))
